...
const Sidebar = ({ expand, setExpand }) => {
  ...
  return (
    <div
      className={`flex flex-col justify-between bg-[#101010] pt-7 transition-all z-50 max-md:absolute max-md:h-screen ${
      ...
      <div>
        ...
        >
          <Image
            ...
            alt={expand ? "afghani ai logo text" : "afghani ai logo icon"}
          />
        ...
        <button
          ...
          className={`mt-8 flex items-center justify-center cursor-pointer ${
            expand
              ? "bg-[var(--color-primary)] hover:bg-[var(--color-accent)] rounded-2xl gap-2 p-2.5 w-max"
        ...
        >
          ...
          >
            <div className="relative w-max bg-black text-white text-sm p-3 rounded-lg shadow-lg">
              ...
              <p>Scan to get Afghani AI App</p>
              <div
                className={`w-3 h-3 absolute bg-black rotate-45 ${
